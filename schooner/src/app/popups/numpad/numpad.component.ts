...
export class NumpadComponent implements OnInit, AfterViewInit {
  @ViewChild('roomCodeInput', { static: false }) roomCode: ElementRef;

  private keyboard: Keyboard;
  roomCodeValue = '';

  constructor(private bottomSheetRef: MatBottomSheetRef<NumpadComponent>, @Inject(MAT_BOTTOM_SHEET_DATA) public data: EventEmitter<string>) {
   }
